...
params:
    ...
    packages: !r c("DT", "dygraphs", "flexdashboard", "ggiraph", "glue", "here", "highcharter", "htmltools", "httr", "jsonlite", "leaflet", "plotly", "sass", "shiny", "shinyalert", "shinycssloaders", "shinydashboard", "shinyjs", "shinytest", "shinyloadtest", "shinythemes", "tidyverse", "timevis")
    r_version: 4.0.2
---
