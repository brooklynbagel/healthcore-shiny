...
params:
    ...
    packages: !r c("shiny", "tidyverse", "here", "glue", "httr", "htmltools", "shinyjs", "shinyalert", "shinycssloaders", "shinythemes", "shinydashboard", "flexdashboard", "DT", "plotly", "highcharter", "leaflet", "dygraphs", "ggiraph", "timevis", "sass", "shinytest", "shinyloadtest", "jsonlite")
    r_version: 4.0.2
---
